...
- 抓取 GitHub、Hacker News、ArXiv、Hugging Face、Product Hunt、Dev.to、Lobste.rs、Bluesky、Mastodon 和 AI 公司官网动态
- 生成中文主页面 `ai-radar.md`
...
- Lobste.rs
- Bluesky AI 关键词高互动讨论
- Mastodon：AI、LLM、Machine Learning 公共话题时间线
- 官网 sitemap：
...
- `ai-social.md`：Bluesky 与 Mastodon 高互动讨论
