...
- 证据：[Claude Code v2.1.282](https://github.com/anthropics/claude-code/releases)、[Claude Code #96849](https://github.com/anthropics/claude-code/issues/96849)、[OpenAI Codex 0.157.0](https://github.com/openai/codex/releases)、[OpenAI Codex #47531](https://github.com/openai/codex/issues/47531)、[OpenAI Codex #47992](https://github.com/openai/codex/issues/47992)
...
- [少看点 AI 雷达](./#2026-09-25/ai-radar) — 先看当天的总判断。
...
- [rohitg00/ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch) — 这是今天判断机会方向的直接证据。
- [vectorize-io/hindsight](https://github.com/vectorize-io/hindsight) — 这是今天判断机会方向的直接证据。

---

> 本页由每日保底脚本生成，用于保证站点每天都有“能继续做什么”的可读版本；后续可以被更高质量的人工 / Codex 版本覆盖。生成时间: 2026-09-25 03:58 UTC