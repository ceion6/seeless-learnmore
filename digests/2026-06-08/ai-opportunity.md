...
- 证据：[Claude Code #66147](https://github.com/anthropics/claude-code/issues/66147)、[Claude Code #66146](https://github.com/anthropics/claude-code/issues/66146)、[Claude Code #42700](https://github.com/anthropics/claude-code/issues/42700)、[Claude Code #63886](https://github.com/anthropics/claude-code/issues/63886)、[Claude Code #39370](https://github.com/anthropics/claude-code/pull/39370)
...
- 证据：[Claude Code #66147](https://github.com/anthropics/claude-code/issues/66147)、[Claude Code #66146](https://github.com/anthropics/claude-code/issues/66146)、[Claude Code #63886](https://github.com/anthropics/claude-code/issues/63886)、[OpenAI Codex #25752](https://github.com/openai/codex/issues/25752)、[Gemini CLI](https://github.com/google-gemini/gemini-cli)
...
### 模型侧机会先保持观察
- 现在看到了什么信号：nvidia/LocateAnything-3B 进入模型热榜，说明模型面仍有活跃样本。
...
- [少看点 AI 雷达](./#2026-06-08/ai-radar) — 先看当天的总判断。
- [今日原始快照 raw-data.json](./raw-data.json) — 看完整原始样本。
- [OpenClaw 活跃仓库](https://github.com/openclaw/openclaw) — 这是今天判断机会方向的直接证据。
- [ZeroClaw 活跃仓库](https://github.com/zeroclaw-labs/zeroclaw) — 这是今天判断机会方向的直接证据。
- [mvanhorn/last30days-skill](https://github.com/mvanhorn/last30days-skill) — 这是今天判断机会方向的直接证据。
- [opencv/opencv](https://github.com/opencv/opencv) — 这是今天判断机会方向的直接证据。

---

> 本页由每日保底脚本生成，用于保证站点每天都有“能继续做什么”的可读版本；后续可以被更高质量的人工 / Codex 版本覆盖。生成时间: 2026-06-08 01:05 UTC