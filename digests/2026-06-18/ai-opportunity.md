...
- [少看点 AI 雷达](./#2026-06-18/ai-radar) — 先看当天的总判断。
- [今日原始快照 raw-data.json](./raw-data.json) — 看完整原始样本。
- [OpenClaw 活跃仓库](https://github.com/openclaw/openclaw) — 这是今天判断机会方向的直接证据。
- [CoPaw 活跃仓库](https://github.com/agentscope-ai/CoPaw) — 这是今天判断机会方向的直接证据。
- [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) — 这是今天判断机会方向的直接证据。
- [n0-computer/iroh](https://github.com/n0-computer/iroh) — 这是今天判断机会方向的直接证据。

---

> 本页由每日保底脚本生成，用于保证站点每天都有“能继续做什么”的可读版本；后续可以被更高质量的人工 / Codex 版本覆盖。生成时间: 2026-06-18 01:07 UTC